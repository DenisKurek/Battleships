...
public class Cell {
     ...
     * @param ship statek do którerego ustawiana jest referencja
     */
     ...
     * @return TRUE jeżeli pole zostału już kliknięte FALSE jeżeli nie zostało
     */
     ...
     * @param state stan który chcemy ustawić
     */
